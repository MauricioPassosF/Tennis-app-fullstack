...
namespace backend_c_.Migrations
{
    ...
    [Migration("20240416192726_RestricoesParaUser")]
    partial class RestricoesParaUser
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Tennis.Models.Game", b =>
                {
                    ...
                    b.ToTable("Games", t =>
                        {
                            t.HasCheckConstraint("CK_Game_Status", "Status IN ('Não agendado','Em andamento', 'Finalizado', 'Não iniciado')");
                        });
                });
